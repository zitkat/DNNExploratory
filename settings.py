...
def load_settings(set_path: Path = Path("settings.csv"),
    ...
    Key, Default, any other coluns are treated as versions of the same variables.
    :param set_path: path to settings file
...
if __name__ == '__main__':
    settings = load_settings(Path("settings_nogroup.ods"), "v2")
    pass